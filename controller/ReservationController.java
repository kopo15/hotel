...
public class ReservationController {
	...
	@GetMapping("/map")
	public String requesttMap() {
		return "howtogo";
	}

	@GetMapping("/tour")
	public String requesttTourSpots() {
		return "tourspots";
	}

	@GetMapping("/room")
	public String requestRoomDetail(@RequestParam("chooseNum") int Roomnum) {
